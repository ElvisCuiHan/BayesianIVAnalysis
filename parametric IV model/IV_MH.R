...
for (i in 2:m) {
	...
	##### Metropolis每Hastings algorithm for a0 #####
	w=wid[1];
	...
	##### Metropolis每Hastings algorithm for (vector) a1 #####
	for (j in 1:kG) {
		w=wid[1+j];
	...
	##### Metropolis每Hastings algorithm for (vector) a2 #####
	for (j in 1:kU) {
		w=wid[1+kG+j];
	...
	##### Metropolis每Hastings algorithm for sig1 #####
	w=wid[2+kG+kU];
	...
	##### Metropolis每Hastings algorithm for b0 #####
	w=wid[3+kG+kU];
	...
	##### Metropolis每Hastings algorithm for b1 #####
	w=wid[4+kG+kU];
	...
	##### Metropolis每Hastings algorithm for (vector) b2 #####
	for (j in 1:kU) {
		w=wid[4+kG+kU+j];
	...
	##### Metropolis每Hastings algorithm for sig2 #####
	w=wid[5+kG+2*kU];
	...
	##### Metropolis每Hastings algorithm for rho #####
	w=wid[6+kG+2*kU];
